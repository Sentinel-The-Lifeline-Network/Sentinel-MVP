  ...
  return (
    <div className="min-h-dvh flex flex-col mesh-bg">
      <div className="px-5 pt-14 pb-4 lg:pt-10">
        ...
        <h1 className="text-3xl font-black tracking-tight" style={{ color: '#151515' }}>History</h1>

        {alerts.length > 0 && (
          <div className="flex gap-4 mt-3">
            {[
              { label: 'Total', value: alerts.length, color: '#6B6B6B' },
              { label: 'Resolved', value: resolved, color: '#1F5A47' },
              { label: 'Cancelled', value: cancelled, color: '#6B6B6B' },
            ].map((stat) => (
      ...
      <div className="flex-1 px-5 pb-28 space-y-2.5">
        {loading ? (
          ...
          <motion.div className="text-center pt-16" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            >
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#0B3D2E" strokeWidth="1.5"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
            </div>
            <p className="font-bold text-lg" style={{ color: '#151515' }}>No alerts yet</p>
